...
#elif defined(CONFIG_MACH_MSM8X10_W5_TRF_US) || defined(CONFIG_MACH_MSM8X10_W5C_TRF_US)
...
#if	defined(CONFIG_MACH_MSM8X10_W5C_TRF_US)
	{
		.seq_type = SENSOR_GPIO,
...
#endif
#if	defined(CONFIG_MACH_MSM8X10_W5_TRF_US)
